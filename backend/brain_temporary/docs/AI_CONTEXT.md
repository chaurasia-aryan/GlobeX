...
The application strictly adheres to the 76 rules documented in [`design_standards.md`](./design/design_standards.md) and the operational flow in [`USER_FLOW.md`](./design/USER_FLOW.md):
