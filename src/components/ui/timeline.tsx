  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <h2 className="text-2xl md:text-4xl mb-3 text-foreground font-bold tracking-tight max-w-4xl">
          From discovery to settlement
        </h2>
        <p className="text-muted-foreground text-sm max-w-lg">
          Every cross-border trade follows a lifecycle. GLOBEX makes each
          stage intelligent, verifiable, and secure.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:text-4xl font-bold text-muted-foreground/60 md:pl-20">
                {item.title}
              </h3>
            </div>
