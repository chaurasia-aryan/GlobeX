...
export const DashboardPage: React.FC = () => {
  ...
  return (
    <AppShell maxWidth="full" className="space-y-6">
      {/* ── Top Operational Context Bar & Dual View Mode Control (Section 4 & 5) ── */}
      <div
        id="command-center"
        className="p-4 sm:p-5 rounded-2xl bg-[#0C121D] border border-white/[0.07] flex flex-col md:flex-row md:items-center justify-between gap-4"
      >
            {/* Context information */}
          ...
          {/* ── PERSISTENT DUAL VIEW OPERATIONAL COLUMNS (Section 1, 6, 7, 8, 9, 10) ── */}
          <div
            id="active-contracts"
            className={cn(
          ...
          >
            ...
            {/* ═════════════════════════════════════════════════════════════════ */}
            {/* ── COLUMN 1: IMPORT DUTY OPERATIONS (Section 6) ──────────────── */}
            {/* ═════════════════════════════════════════════════════════════════ */}
            {(viewMode === "dual" || viewMode === "import") && (
              ...
              >
                ...
                <div className="space-y-3 border-b border-white/[0.06] pb-4">
                  ...
                  {/* ── Large Business Numbers (Section 8) ────────────────── */}
                ...
                {/* ── Active Inbound Contracts with AnimatedList (Section 9 & 10) ── */}
                ...
                {/* ── Single Primary CTA: SpecularButton (Section 10 & 15) ── */}
            ...
            {/* ═════════════════════════════════════════════════════════════════ */}
            {/* ── COLUMN 2: EXPORT DUTY OPERATIONS (Section 7) ──────────────── */}
            {/* ═════════════════════════════════════════════════════════════════ */}
            {(viewMode === "dual" || viewMode === "export") && (
              ...
              >
                ...
                {/* ── Active Outbound Contracts with AnimatedList (Section 9 & 10) ── */}
                <div className="space-y-2 flex-1">
                  <div className="flex items-center justify-between text-xs font-mono text-slate-400 uppercase px-1">
          ...
          {/* ── TARIFF CALCULATOR (Section 12 & 17) ─────────────────────────── */}
          <div
            id="tariff-intelligence"
            className="p-5 sm:p-6 rounded-2xl bg-[#0C121D] border border-white/[0.07] space-y-4"
          >
          ...
          {/* ── SETTLEMENT & PLATFORM CAPABILITY MATRIX (Section 13 & 18) ───── */}
          <div
            id="settlement-vault"
            className="p-5 sm:p-6 rounded-2xl bg-[#0C121D] border border-white/[0.07] space-y-4"
          >
